...
// (public/legal/terms.html, last updated 21 September 2026). Do not invent or
...
export const termsPage = {
  ...
  sections: [
    ...
    },
    {
      heading: "Trial",
      paragraphs: [
        "New accounts receive a 14-day trial, started in the app with no payment method required. When the trial ends, your journal remains intact and fully exportable; new writing and the reflective features require a subscription.",
      ],
    },
    {
      heading: "Refunds",
