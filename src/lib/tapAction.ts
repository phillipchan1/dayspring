 ...
 * dropped — the control looks dead. Firing on pointerdown for touch/pen (before
 * the mouse dance) and on click for mouse/keyboard avoids that. The ref survives
 * the re-render that the action itself may trigger, so click does not double-fire.
 */
