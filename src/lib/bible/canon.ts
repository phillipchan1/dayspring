...
export const BOOKS: BibleBook[] = [
  ...
  { osis: '1Sam', name: '1 Samuel', order: 9, testament: 'OT', chapters: 31, abbr: ['1 samuel', '1 sam', '1 sa', '1sam', '1sa', '1s', 'i samuel', 'i sam', 'first samuel', '1st samuel', '1st sam'] },
  { osis: '2Sam', name: '2 Samuel', order: 10, testament: 'OT', chapters: 24, abbr: ['2 samuel', '2 sam', '2 sa', '2sam', '2sa', '2s', 'ii samuel', 'ii sam', 'second samuel', '2nd samuel', '2nd sam'] },
  { osis: '1Kgs', name: '1 Kings', order: 11, testament: 'OT', chapters: 22, abbr: ['1 kings', '1 kgs', '1 kin', '1kings', '1kgs', '1ki', 'i kings', 'first kings', '1st kings', '1st kgs', 'i kgs'] },
  { osis: '2Kgs', name: '2 Kings', order: 12, testament: 'OT', chapters: 25, abbr: ['2 kings', '2 kgs', '2 kin', '2kings', '2kgs', '2ki', 'ii kings', 'second kings', '2nd kings', '2nd kgs', 'ii kgs'] },
  { osis: '1Chr', name: '1 Chronicles', order: 13, testament: 'OT', chapters: 29, abbr: ['1 chronicles', '1 chron', '1 chr', '1chron', '1chr', '1ch', 'i chronicles', 'first chronicles', '1st chronicles', '1st chr', 'i chr'] },
  { osis: '2Chr', name: '2 Chronicles', order: 14, testament: 'OT', chapters: 36, abbr: ['2 chronicles', '2 chron', '2 chr', '2chron', '2chr', '2ch', 'ii chronicles', 'second chronicles', '2nd chronicles', '2nd chr', 'ii chr'] },
  ...
  { osis: '1Cor', name: '1 Corinthians', order: 46, testament: 'NT', chapters: 16, abbr: ['1 corinthians', '1 cor', '1 co', '1corinthians', '1cor', '1co', 'i corinthians', 'first corinthians', '1st corinthians', '1st cor', 'i cor'] },
  { osis: '2Cor', name: '2 Corinthians', order: 47, testament: 'NT', chapters: 13, abbr: ['2 corinthians', '2 cor', '2 co', '2corinthians', '2cor', '2co', 'ii corinthians', 'second corinthians', '2nd corinthians', '2nd cor', 'ii cor'] },
  ...
  { osis: '1Thess', name: '1 Thessalonians', order: 52, testament: 'NT', chapters: 5, abbr: ['1 thessalonians', '1 thess', '1 thes', '1 th', '1thessalonians', '1thess', '1th', 'i thessalonians', 'first thessalonians', '1st thessalonians', '1st thess', 'i thess'] },
  { osis: '2Thess', name: '2 Thessalonians', order: 53, testament: 'NT', chapters: 3, abbr: ['2 thessalonians', '2 thess', '2 thes', '2 th', '2thessalonians', '2thess', '2th', 'ii thessalonians', 'second thessalonians', '2nd thessalonians', '2nd thess', 'ii thess'] },
  { osis: '1Tim', name: '1 Timothy', order: 54, testament: 'NT', chapters: 6, abbr: ['1 timothy', '1 tim', '1 ti', '1timothy', '1tim', '1ti', 'i timothy', 'first timothy', '1st timothy', '1st tim', 'i tim'] },
  { osis: '2Tim', name: '2 Timothy', order: 55, testament: 'NT', chapters: 4, abbr: ['2 timothy', '2 tim', '2 ti', '2timothy', '2tim', '2ti', 'ii timothy', 'second timothy', '2nd timothy', '2nd tim', 'ii tim'] },
  ...
  { osis: '1Pet', name: '1 Peter', order: 60, testament: 'NT', chapters: 5, abbr: ['1 peter', '1 pet', '1 pe', '1peter', '1pet', '1pe', '1pt', 'i peter', 'first peter', '1st peter', '1st pet', 'i pet'] },
  { osis: '2Pet', name: '2 Peter', order: 61, testament: 'NT', chapters: 3, abbr: ['2 peter', '2 pet', '2 pe', '2peter', '2pet', '2pe', '2pt', 'ii peter', 'second peter', '2nd peter', '2nd pet', 'ii pet'] },
  { osis: '1John', name: '1 John', order: 62, testament: 'NT', chapters: 5, abbr: ['1 john', '1 jhn', '1 jn', '1john', '1jhn', '1jn', '1jo', 'i john', 'first john', '1st john', '1st jn', 'i jn'] },
  { osis: '2John', name: '2 John', order: 63, testament: 'NT', chapters: 1, abbr: ['2 john', '2 jhn', '2 jn', '2john', '2jhn', '2jn', '2jo', 'ii john', 'second john', '2nd john', '2nd jn', 'ii jn'] },
  { osis: '3John', name: '3 John', order: 64, testament: 'NT', chapters: 1, abbr: ['3 john', '3 jhn', '3 jn', '3john', '3jhn', '3jn', '3jo', 'iii john', 'third john', '3rd john', '3rd jn', 'iii jn'] },
