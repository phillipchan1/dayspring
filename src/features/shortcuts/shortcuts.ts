...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    title: 'Writing',
    items: [
      { keys: ['C'], label: 'New entry', when: 'while reading' },
      { keys: ['E'], label: 'Edit this entry', when: 'while reading' },
      { keys: ['Esc'], label: 'Done editing — back to reading', when: 'while writing' },
