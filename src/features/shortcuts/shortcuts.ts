...
export const SHORTCUT_GROUPS: ShortcutGroup[] = [
  {
    ...
    items: [
      ...
      { keys: ['Mod', 'B'], label: 'Bold', when: 'in the editor' },
      { keys: ['Mod', 'I'], label: 'Italic', when: 'in the editor' },
      { keys: ['Mod', 'U'], label: 'Underline', when: 'in the editor' },
      { keys: ['Mod', 'Shift', 'H'], label: 'Highlight', when: 'in the editor' },
      { keys: ['Mod', 'E'], label: 'Inline code', when: 'in the editor' },
      { keys: ['Mod', 'Shift', 'F'], label: 'Show formatting', when: 'in the editor' },
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ['Mod', 'F'], label: 'Search your pages', when: 'anywhere' },
      { keys: ['/'], label: 'Search from the wall', when: 'on the Pages wall' },
      { keys: ['↑', '↓'], label: 'Move through what you found', when: 'in Look for' },
      { keys: ['Esc'], label: 'Clear the search', when: 'in the Look for field' },
