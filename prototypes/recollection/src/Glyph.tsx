  ...
  switch (kind) {
    ...
    case 'gift':
      return (
        <svg {...common}>
          <path
            d="M2.6 9.5 A3.4 3.4 0 0 0 9.4 9.5"
            stroke="var(--k-gift)"
            strokeWidth="1.4"
            strokeLinecap="round"
            fill="none"
          />
          <circle cx="6" cy="5.6" r="1.5" fill="var(--k-gift)" />
        </svg>
      )
    ...
    case 'absence':
      return (
        <svg {...common}>
          <path d="M6 2 V8.4" stroke="var(--k-absence)" strokeWidth="1.3" strokeLinecap="round" />
          <path d="M6 13.6 V20" stroke="var(--k-absence)" strokeWidth="1.3" strokeLinecap="round" />
        </svg>
      )
