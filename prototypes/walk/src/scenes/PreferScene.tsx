...
const OPTIONS: { id: Preference; label: string }[] = [
  {
    id: 'A',
    label:
      'Build it. Lectio declares four kinds; the other twelve practices and every past entry are untouched.',
  },
  {
    id: 'B',
    label:
      'The passage half only — Bring and Carry. Leave Meditatio a normal field and Contemplatio alone.',
  },
  {
    id: 'C',
    label:
      'Not yet. Find out which movement people actually stop at before changing Lectio’s shape.',
  },
...
export function PreferScene() {
  ...
  return (
    <form className="paper prefer" onSubmit={handleSubmit}>
      <h2 className="prefer__title">Is this worth building for Lectio?</h2>
